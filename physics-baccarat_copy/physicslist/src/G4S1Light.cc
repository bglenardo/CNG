...
// Version:     1.00 alpha 1b LUX edition
// Created:     Thursday, October 2, 2014 08:04 A.M.
...
{
        //baccManager = baccSimManager::GetManager();
...
// this is the most important function, where all light & charge yields happen!
{
	...
	G4double kappa = 0.1394; //0.133*pow(z1,(2./3.))*pow(a2,(-1./2.))*(2./3.);
	  ...
	  for(i=0;i<j;i++) {
		...
		if(recombProb>1) recombProb=1;
	      ...
	      //just like Doke: simple binomial distribution
 	      G4double FanoFactor = 0.009 * NumIons;

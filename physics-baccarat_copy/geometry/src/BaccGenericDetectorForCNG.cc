////////////////////////////////////////////////////////////////////////////////
/*  BaccGenericDetectorForCNG.cc

This is the code file to define the generic detector for studies of a compact
neutron generator in a source tube. It has been copied from ExampleNobleTPC and
modified as necessary.
********************************************************************************
Change log
  2014/10/06 - Copied over, names changed accordingly. (Brian)
  2014/10/06 - Changed dimensions of active target to 75cm tall
               and 40 cm radius. Changed material of cryostat and outer
               can to Titanium. 
  2014/10/08 - Added locations of PMTs. The water tank is being added, but
               in the file BaccDetectorConstruction.cc
  2014/10/09 - Scratched that idea, added water tank directly to this file.
               logicalVolume is now the outer steel tank. (Brian)
*/
////////////////////////////////////////////////////////////////////////////////
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
BaccGenericDetectorForCNG::BaccGenericDetectorForCNG( G4String detName,
        G4String outVolName )
{
    ...
    totalCentralVolumeRadius = 40.*cm;
    ...
    // Also include the water tank in here.
    waterVolumeHalfHeight = 3.0*m;
    waterVolumeRadius     = 3.0*m;
    
    waterTankThickness    = 0.02*m;
  
    waterTankHalfHeight   = waterVolumeHalfHeight + waterTankThickness;
    waterTankRadius       = waterVolumeRadius + waterTankThickness;

    //  Set the default detector material to xenon. This means the target volume
    //  is liquid xenon and the gain volume is gaseous xenon.
    tpcMaterial = "Xenon";
}
...
//				~BaccGenericDetectorForCNG
//------++++++------++++++------++++++------++++++------++++++------++++++------
BaccGenericDetectorForCNG::~BaccGenericDetectorForCNG() {}

//------++++++------++++++------++++++------++++++------++++++------++++++------
//				BuildDetector
//------++++++------++++++------++++++------++++++------++++++------++++++------
void BaccGenericDetectorForCNG::BuildDetector()
{
    //
    ...
    // Start with the water tank.
    G4Tubs * waterTank_solid = new G4Tubs("waterTank_solid", 0, waterTankRadius,
                                           waterTankHalfHeight, 0.*deg, 360.*deg);
    logicalVolume = new G4LogicalVolume ( waterTank_solid, baccMaterials->Steel(),
                                          "waterTank_log" );
    logicalVolume->SetVisAttributes( baccMaterials->SteelVis() );

    // Add the water to the water tank.
    G4Tubs * waterVolume_solid = new G4Tubs("waterVolume_solid", 0,
                                 waterVolumeRadius, waterVolumeHalfHeight,
                                 0.*deg, 360.*deg);
    G4LogicalVolume *waterVolume_log = new G4LogicalVolume( waterVolume_solid, 
                          baccMaterials->Water(), "waterVolume_log" );
    waterVolume_log->SetVisAttributes( baccMaterials->VacuumVis() );
    ...
    G4LogicalVolume *vacuumVessel_log = new G4LogicalVolume( vacuumVessel_solid,
            baccMaterials->Titanium(), "vacuumVessel_log" );
    vacuumVessel_log->SetVisAttributes( baccMaterials->TitaniumVis() );
    ...
    G4LogicalVolume *cryostat_log = new G4LogicalVolume( cryostat_solid,
            baccMaterials->Titanium(), "cryostat_log" );
    cryostat_log->SetVisAttributes( baccMaterials->TitaniumVis() );
...
*/
    ...
    G4double pmtXOffset[140] = {-69.120000,-57.600000,-46.080000,-34.560000,-23.040000,
-11.520000,
0.000000,
11.520000,
23.040000,
...
-28.800000};
    ...
    G4double pmtYOffset[140] = {0.000000,
0.000000,
0.000000,
0.000000,
0.000000,
...
-69.836289};
    ...
    for(int ii=0; ii<140; ii++) {
      pmtXOffset[ii] = pmtXOffset[ii]*5.;
      pmtYOffset[ii] = pmtYOffset[ii]*5.;
    }
    ...
    BaccExample8778PMT *bottomPMTs[140];
    BaccDetectorComponent *bottomPMT[140];
    G4LogicalBorderSurface *pmtCanLiquidSurface[140];
    ...
    BaccExample8778PMT *topPMTs[140];
    BaccDetectorComponent *topPMT[140];
    G4LogicalBorderSurface *pmtCanGasSurface[140];

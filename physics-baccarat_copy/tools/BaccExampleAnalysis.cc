////////////////////////////////////////////////////////////////////////////////
/*	BaccExampleAnalysis.cc

An example of how to access data from the Bacc TTree.  This script includes code 
that grabs a PMT lookup table by number, and references the location of that 
number PMT.  For now, two histograms of the top and bottom PMT response are 
included.  To run, type the follwing in the command line: 
  gmake
  ./exampleAnalysis BaccOut837493234.root
Two plots for the top and bottom PMT hit maps will be created as .pdf (Melinda)
********************************************************************************
Change log

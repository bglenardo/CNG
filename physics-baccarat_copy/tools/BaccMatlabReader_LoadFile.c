////////////////////////////////////////////////////////////////////////////////////////////////////
/*	BaccMatlabReader_LoadFile.c
*
* Loads data into 1x1 structure with array fields for BaccMatlabReader.  BEWARE: this is included as
* is from the LUXSim-BACCARAT split.  I have no knowlege, wisdom or understanding to offer you when 
* it comes to doing things like this in MATLAB. (Vic)
*
****************************************************************************************************
* Change log
